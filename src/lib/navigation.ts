...
export const NAV_STRUCTURE: NavCategory[] = [
  ...
  },
  {
    ...
    icon: 'mail',
    items: [
      { slug: 'email-gateway/seg-policy-and-authentication', title: 'SEG策略攔截與認證' },
      { slug: 'email-gateway/email-encryption-overview', title: '郵件加密外發匯總' },
      { slug: 'email-gateway/api-encrypted-release', title: '隔離後API加密釋放記錄' },
    ]
  },
  {
    id: 'dlp',
    ...
    items: [
      ...
      { slug: 'dlp/endpoint-linux', title: '终端Linux' },
      { slug: 'dlp/endpoint-mac', title: '终端Mac' },
      { slug: 'dlp/endpoint-misc-troubleshooting', title: '终端其他故障排查' },
      { slug: 'dlp/endpoint-ocr-testing', title: '终端OCR测试指南' },
      { slug: 'dlp/endpoint-offline-troubleshooting', title: '解决与天空卫士或亿赛通端口冲突' },
      { slug: 'dlp/endpoint-lag-troubleshooting', title: '解决开启天空卫士或亿赛通端口冲突' },
      ...
      { slug: 'dlp/endpoint-screenshot-troubleshooting', title: '终端截图故障排查' },
      ...
      { slug: 'dlp/endpoint-uuid-issues', title: '终端UUID问题' },
